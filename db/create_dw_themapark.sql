...
CREATE TABLE "THEME_ENTRANCE2" (
	"TE2_IDX"	int	GENERATED BY DEFAULT AS IDENTITY	NOT NULL,
	"THEME_NUM"	int		NOT NULL,
	"STD_DATE"	date		NULL,
	"ENT_NUM"	int		NULL
);

COMMENT ON COLUMN "THEME_ENTRANCE2"."THEME_NUM" IS '테마파크 번호';

COMMENT ON COLUMN "THEME_ENTRANCE2"."STD_DATE" IS '날짜(월별)';

COMMENT ON COLUMN "THEME_ENTRANCE2"."ENT_NUM" IS '입장객수';
...
CREATE TABLE "HOLIDAY" (
	"H_IDX"	int	 GENERATED BY DEFAULT AS IDENTITY	NOT NULL,
	"STD_DATE"	date		NULL,
	"HOLIDAY_OX"	int		NULL
);

COMMENT ON COLUMN "HOLIDAY"."STD_DATE" IS '날짜(일별)';

COMMENT ON COLUMN "HOLIDAY"."HOLIDAY_OX" IS '공휴일 여부 (0/1)';
...
ALTER TABLE "THEME_ENTRANCE1" ADD CONSTRAINT "PK_THEME_ENTRANCE1" PRIMARY KEY (
	"TE_IDX"
);
...
ALTER TABLE "THEME_ENTRANCE2" ADD CONSTRAINT "PK_THEME_ENTRANCE2" PRIMARY KEY (
	"TE2_IDX"
);



ALTER TABLE "THEME_ENTRANCE1" ADD CONSTRAINT "FK_THEME_ENTRANCE1_TO_THEMEPARK" FOREIGN KEY ("THEME_NUM") REFERENCES "THEMEPARK" ("THEME_NUM");

ALTER TABLE "THEME_ENTRANCE2" ADD CONSTRAINT "FK_THEME_ENTRANCE2_TO_THEMEPARK" FOREIGN KEY ("THEME_NUM") REFERENCES "THEMEPARK" ("THEME_NUM");
...
ALTER TABLE "DAILY_WEATHER" ADD CONSTRAINT "FK_DAILY_WEATHER_TO_THEMEPARK" FOREIGN KEY ("THEME_NUM") REFERENCES "THEMEPARK" ("THEME_NUM");

ALTER TABLE "DAILY_AIR" ADD CONSTRAINT "FK_DAILY_AIR_TO_THEMEPARK" FOREIGN KEY ("THEME_NUM") REFERENCES "THEMEPARK" ("THEME_NUM");