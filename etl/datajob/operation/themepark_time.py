...
class ThemeparkTime:
    ...
    def save(cls, after_cnt=7):
        ...
        for i in range(0, after_cnt):
            cls.__everland_op_time(data, i)

            cls.__lotteworld_op_time(data, i)

            cls.__seoulpark_op_time(data, i)

            cls.__childpark_op_time(data, i)
    ...
    # 서울어린이대공원 운영시간
    @classmethod
    def __childpark_op_time(cls, data, i):
    ...
    # 서울대공원 운영시간
    @classmethod
    def __seoulpark_op_time(cls, data, i):
    ...
    # 롯데월드 운영시간
    @classmethod
    def __lotteworld_op_time(cls, data, i):
    ...
    # 에버랜드 운영시간
    @classmethod
    def __everland_op_time(cls, data, i):
